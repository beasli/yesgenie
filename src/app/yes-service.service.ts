...
const productbysubcat = 'https://www.yesgenie.com/app/registration/productbysubcategory';
...
@Injectable({
 ...
 export class YesServiceService {
  ...
  constructor(private http: HttpClient, private storage: Storage,  private applicationRef: ApplicationRef,
    private toastCtrl: ToastController,  public alertCtrl: AlertController, public events: Events) { 
    ...
    category(): Observable<any> {
      ...
      registerUser(credentials) {
        return new Promise((resolve, reject) => {
          ...
          this.http.post(base_url_register, credentials)
            .subscribe(res => {
             resolve(res);
            }, (err) => {
              reject(err);
      ...
      verifyOTP(credentials) {
        return new Promise((resolve, reject) => {
          ...
          this.http.post(base_url_verify, credentials)
            .subscribe(res => {
             resolve(res);
            }, (err) => {
              reject(err);
      ...
      sendotp(credentials) {
        return new Promise((resolve, reject) => {
          ...
          this.http.post(base_url_send_otp, credentials)
            .subscribe(res => {
             resolve(res);
            }, (err) => {
              reject(err);
      ...
      loginUser(credentials) {
        return new Promise((resolve, reject) => {
          ...
          this.http.post(`${main_url}/login`, credentials)
            .subscribe(res => {
             resolve(res);
            }, (err) => {
              reject(err);
      ...
      fblogin(credentials) {
        return new Promise((resolve, reject) => {
          ...
          this.http.post(`${main_url}/Gettokenbyfb`, credentials)
            .subscribe(res => {
             resolve(res);
            }, (err) => {
              reject(err);
                  ...
                  productbysubcategory(data5): Observable<any> {
                    ...
                    addtocartvariation(credentials) {
                      return new Promise((resolve, reject) => {
                        ...
                        this.http.post(`${main_url}/addtocartvariation`, credentials)
                          .subscribe(res => {
                           resolve(res);
                          }, (err) => {
                            reject(err);
                    ...
                    Productvariation(credentials) {
                      return new Promise((resolve, reject) => {
                        ...
                        this.http.post(`${main_url}/Productvariation`, credentials)
                          .subscribe(res => {
                           resolve(res);
                          }, (err) => {
                            reject(err);
                    ...
                    Getmultipleshippingaddress(credentials) {
                      return new Promise((resolve, reject) => {
                        ...
                        this.http.post(`${main_url}/Getmultipleshippingaddress`, credentials)
                          .subscribe(res => {
                           resolve(res);
                          }, (err) => {
                            reject(err);
                    ...
                    Getcustomfieldproduct(data): Observable<any> {
                      ...
                      addToCart(p, product_quantity, v, ProValQunt) {
                        ...
                        if (product_quantity == null || product_quantity == "null") d.product_quantity = 1;
                        else { d.product_quantity = product_quantity; console.log(product_quantity); console.log("quantity not null"); };
