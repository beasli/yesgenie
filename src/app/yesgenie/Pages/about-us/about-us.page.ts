...
export class AboutUsPage implements OnInit {
  ...
  public iconColorVar = "";
  data: any;
  constructor(public service1: YesServiceService, public services: ShareService, public toastController: ToastController, private service: CustomThemeService, public menuCtrl: MenuController, public shared: SharedDataService, public config: ConfigService, translate: TranslateService, public modalCtrl: ModalController, public nav: NavController
  ) {
