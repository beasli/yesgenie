...
export class ContactUsPage implements OnInit {
  ...
  errorMessage = '';
  constructor(public services: ShareService, private service: CustomThemeService,public menuCtrl: MenuController, public shared: SharedDataService, public config: ConfigService, translate: TranslateService, public nav: NavController) { 
